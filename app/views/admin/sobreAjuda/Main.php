      ...
      <div class="col-12">
          <div class="card">
              <div class="card-header">
                  <h4 class="card-title">Sobre & Ajuda <i class="fa fa-file-circle-question"></i></h4>
              </div>
              <div class="card-body">
                  ...
                  <div class="bootstrap-modal">
                      ...
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#basicModal">Políticas de Dados</button>
                      <!-- Modal -->
                      ...
                      <!-- Button trigger modal -->
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLong">Termos de Licença</button>
                      <!-- Modal -->
                      ...
                      <!-- Button trigger modal -->
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">Manual do Usuário</button>
                      <!-- Modal -->
                      ...
                      <!-- Button trigger modal -->
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalpopover">Contrato de Licença</button>
                      <!-- Modal -->
                      ...
                      <!-- Large modal -->
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg">Ajuda e Recomendações</button>
                      ...
                      <!-- Small modal -->
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-sm">Versões & Comunidade</button>
